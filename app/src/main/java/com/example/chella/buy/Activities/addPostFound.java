...
public class addPostFound extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_post_found);
        mAuth = FirebaseAuth.getInstance();
        muser = mAuth.getCurrentUser();
        database = FirebaseDatabase.getInstance();
        mdataBaseReference = database.getReference().child("mFound");
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                int rgsid= radio.getCheckedRadioButtonId();
                radioButton=findViewById(rgsid);
                startPosting();
    ...
    private void startPosting() {
        ...
        final String priceval = radioButton.getText().toString();
        ...
        if (!TextUtils.isEmpty(titleval)&&!TextUtils.isEmpty(priceval)){
            ...
            filepath.putFile(imguri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    startActivity(new Intent(addPostFound.this,lostAndFound.class));
                    finish();
